            ...
            <div class="flex items-center gap-4 mb-6 pb-4" style="border-bottom: 1px solid var(--c-gray-100);">
                ...
                <div>
                    <h2 style="font-size: 1.5rem; font-weight: 900; color: var(--c-gray-900);">
                        {{ Auth::user()->role === 'admin' ? 'Update Status Barang' : 'Edit Data Barang' }}
                    </h2>
            ...
            <form method="POST" action="{{ route('items.update', $item) }}" enctype="multipart/form-data">
                ...
                @if(Auth::user()->role === 'admin')
                    ...
                    <div class="form-group">
                        <label class="form-label">Pilih Status Terbaru</label>
                        <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                            <label
                                ...
                                <span style="font-weight: 700; color: var(--c-warning-text);">Pending</span>
                            </label>
                            ...
                            <label
                                ...
                                <span style="font-weight: 700; color: var(--c-primary);">Stored / Disimpan</span>
                            </label>
                            ...
                            <label
                                ...
                                <span style="font-weight: 700; color: var(--c-success-text);">Retrieved / Diambil</span>
                            </label>
                        </div>
                ...
                @else
                    ...
                    <div class="form-group">
                        <label for="characteristics" class="form-label">Ciri-ciri Khusus (Lecet, dll)</label>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <p class="text-xs text-gray-500 mb-2">Pilih file untuk menambah foto barang (Total max 5 foto gabungan).</p>
                        <div class="relative group cursor-pointer h-48 border-2 border-dashed border-gray-300 rounded-2xl bg-gray-50 flex flex-col items-center justify-center transition-all overflow-hidden"
                            ...
                            <div id="upload-state-edit"
                                ...
                                <p style="margin-top: 1rem; font-weight: 700; color: var(--c-gray-900);">Klik untuk
                                    memperbarui foto (bisa >1)</p>
                                <p style="font-size: 0.75rem; color: var(--c-gray-500); margin-top: 0.25rem;">Max 2MB per
                                    foto (JPG, PNG)</p>
                            </div>
