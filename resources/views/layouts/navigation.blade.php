        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-6">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5 group shrink-0"
                    ...
                    <span
                        class="font-black text-xl text-gray-800 uppercase tracking-wider">{{ \App\Helpers\SettingHelper::get_localized('app_name') ?? 'PenitipanApp' }}</span>
                </a>
                ...
                <div class="hidden sm:flex items-center gap-3 ml-4">
                    ...
                    @else
                        @if(request()->is('/'))
                            <a href="#cara-kerja"
                                class="text-sm font-bold uppercase text-gray-600 hover:text-amber-600 hover:bg-white/50 px-3 py-2 rounded-xl transition-colors">{{ __('Cara Kerja') }}</a>
                            <a href="#harga"
                                class="text-sm font-bold uppercase text-gray-600 hover:text-amber-600 hover:bg-white/50 px-3 py-2 rounded-xl transition-colors">{{ __('Harga') }}</a>
                            <a href="#lokasi"
                                class="text-sm font-bold uppercase text-gray-600 hover:text-amber-600 hover:bg-white/50 px-3 py-2 rounded-xl transition-colors">{{ __('Lokasi') }}</a>
                            <a href="#faq"
                                class="text-sm font-bold uppercase text-gray-600 hover:text-amber-600 hover:bg-white/50 px-3 py-2 rounded-xl transition-colors">{{ __('FAQ') }}</a>
                        @endif
                    @endauth
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center pl-6 my-2 border-l border-white/40 gap-4">
                ...
                @else
                    <div class="flex items-center gap-2 border-l border-white/40 pl-4">
                        <a href="{{ route('login') }}"
                            class="px-4 py-2 text-sm font-bold uppercase text-gray-700 hover:bg-white/50 rounded-xl transition-colors">{{ \App\Helpers\SettingHelper::get_localized('login_btn_text', 'Masuk') }}</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="px-4 py-2 rounded-xl bg-gray-900 text-white text-sm font-bold uppercase hover:bg-gray-800 transition-all shadow-sm">{{ \App\Helpers\SettingHelper::get_localized('register_btn_text', 'Daftar') }}</a>
                        @endif
                    </div>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden glass-panel border-t border-white/60">
        <div class="p-4 space-y-2">
            ...
            @else
                @if(request()->is('/'))
                    <a href="#cara-kerja"
                        class="block px-4 py-3 rounded-xl border border-transparent text-sm font-bold uppercase text-gray-800 hover:bg-white/50 transition-colors">{{ __('Cara Kerja') }}</a>
                    <a href="#harga"
                        class="block px-4 py-3 rounded-xl border border-transparent text-sm font-bold uppercase text-gray-800 hover:bg-white/50 transition-colors">{{ __('Harga') }}</a>
                    <a href="#lokasi"
                        class="block px-4 py-3 rounded-xl border border-transparent text-sm font-bold uppercase text-gray-800 hover:bg-white/50 transition-colors">{{ __('Lokasi') }}</a>
                    <a href="#faq"
                        class="block px-4 py-3 rounded-xl border border-transparent text-sm font-bold uppercase text-gray-800 hover:bg-white/50 transition-colors">{{ __('FAQ') }}</a>
                @endif
            @endauth
        </div>
        ...
        <div class="p-4 bg-white/20 border-t border-white/40">
            ...
            @else
                <div class="flex gap-2">
                    <a href="{{ route('login') }}"
                        class="flex-1 text-center py-2.5 rounded-xl border border-white/60 bg-white/40 hover:bg-white/60 text-sm font-bold text-gray-800 transition-colors">{{ \App\Helpers\SettingHelper::get_localized('login_btn_text', 'Masuk') }}</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="flex-1 text-center py-2.5 rounded-xl bg-gray-900 hover:bg-gray-800 text-white text-sm font-bold transition-colors">{{ \App\Helpers\SettingHelper::get_localized('register_btn_text', 'Daftar') }}</a>
                    @endif
                </div>
            @endauth
        </div>
