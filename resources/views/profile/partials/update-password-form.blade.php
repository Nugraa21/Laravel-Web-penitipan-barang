<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="current_password" value="Kata Sandi Saat Ini" class="text-gray-700 font-bold mb-2" />
        ...
        <div>
            <x-input-label for="password" value="Kata Sandi Baru" class="text-gray-700 font-bold mb-2" />
