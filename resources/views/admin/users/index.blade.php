    ...
    <div class="max-w-6xl mx-auto py-12 lg:py-16 my-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 pb-6 border-b border-gray-200">
            <div class="flex items-center gap-4">
                <div
                    class="w-12 h-12 rounded-xl bg-purple-100 text-purple-600 flex items-center justify-center shadow-sm">
                            ...
                            <tr class="hover:bg-white/40 transition-colors">
                                <td class="py-4 px-6 font-bold text-gray-900">
                                    <a href="{{ route('admin.users.show', $u) }}"
                                        class="hover:text-orange-500 transition-colors">{{ $u->name }}</a>
                                </td>
